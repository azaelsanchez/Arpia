      ...
      <div className="relative max-w-6xl mx-auto px-6 py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          <div className="flex items-center justify-center lg:justify-start gap-4 mb-8">
            ...
            <span className="text-[#a855f7] text-xs tracking-[0.4em] uppercase">{t.quienes.tag}</span>
          </div>
          ...
          <p
            ...
            dangerouslySetInnerHTML={{
              __html: t.quienes.p1.replace('<b>', '<span class="text-[#a855f7] font-semibold">').replace('</b>', '</span>'),
            }}
          />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <a
              href="#artistas"
              className="px-8 py-3 bg-[#a855f7] text-black font-semibold tracking-widest uppercase text-sm hover:bg-[#9333ea] transition-colors duration-200"
            >
              {t.quienes.btnArtistas}
            </a>
            <a
              href="#contacto"
              className="px-8 py-3 border border-[#a855f7] text-[#a855f7] font-semibold tracking-widest uppercase text-sm hover:bg-[#a855f7]/10 transition-colors duration-200"
            >
              {t.quienes.btnCita}
            </a>
          </div>
        ...
        <div className="relative">
          <div className="absolute -inset-2 bg-[#a855f7]/10 blur-xl rounded-sm" />
          <img
            src={nosotros}
            alt="Arpia Tattoo estudio"
            className="relative w-full h-[500px] object-cover border border-[#a855f7]/20" style={{ objectPosition: 'center -15px' }}
          />
        </div>
